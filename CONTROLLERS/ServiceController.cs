...
namespace WebApps.Controllers
{
    public class ServiceController : Controller
    {
        ...
        public ActionResult GeneratePdf(string rasio, string jenis, string klasifikasi, string subklasifikasi, string metode, int tahun1, int tahun2, double penjualan, double pokokPenjualan, double bebanOperasional, double labaKotor, double labaOperasional, double testedParty, string namaperusahaan)
        {
            ...
            footer.Add(new Chunk("ini ditujukan sebagai informasi umum dan tidak dimaksudkan sebagai rekomendasi spesifik. Untuk penjelasan lebih lanjut mengenai hasil analisis atau perusahaan pembanding, silahkan konsultasi lebih lanjut melalui kontak resmi PT Central Data Access (�CDA�).", textFont));
